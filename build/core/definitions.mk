...
$(foreach lib,$(PRIVATE_ALL_WHOLE_STATIC_LIBRARIES), \
	...
	mod=$(basename $(notdir $(lib))); \
	ldir=$(PRIVATE_INTERMEDIATES_DIR)/WHOLE/$${mod}_objs;\
	rm -rf $$ldir; \
	mkdir -p $$ldir; \
	filelist=; \
	for f in `$(TARGET_AR) t $(lib)`; do \
	    $(TARGET_AR) p $(lib) $$f > $$ldir/$$mod.$$f; \
	    filelist="$$filelist $$ldir/$$mod.$$f"; \
	done ; \
...
@echo $@ > $(PRIVATE_INTERMEDIATES_DIR)/.arparams
$(foreach obj,$(PRIVATE_ALL_OBJECTS), \
       @echo $(obj) >> $(PRIVATE_INTERMEDIATES_DIR)/.arparams
)
$(hide) $(TARGET_AR) $(TARGET_GLOBAL_ARFLAGS) $(PRIVATE_ARFLAGS) @$(PRIVATE_INTERMEDIATES_DIR)/.arparams
@rm -f $(PRIVATE_INTERMEDIATES_DIR)/.arparams
endef
